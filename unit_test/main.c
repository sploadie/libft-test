...
UT_TEST(ft_atoi)
{
	...
	UT_ASSERT_EQ(ft_atoi("2147483647"), 2147483647);
	UT_ASSERT_EQ(ft_atoi("2147483648"), -2147483648);
	UT_ASSERT_EQ(ft_atoi("9223372036854775807"), -1);
	UT_ASSERT_EQ(ft_atoi("9223372036854775806"), -2);
	UT_ASSERT_EQ(ft_atoi("9223372036854775808"), -1);
	UT_ASSERT_EQ(ft_atoi("2398472983749236582739823758723469826928374"), -1);
